...
function catNoise(num, size) {
    ...
    base["p_base_freq"] = freq;
    return base;
}

const CATS = {};
function makeLion(num, size) {
    const l = $(`<div style="width: 200px; min-height: 100px; display: inline-block;" class="noselect" draggable=false><img src="cat.svg" class="clickable" draggable=false></div>`);
